...
# Primary digital-signature algorithm: RSA signature with SHA-256.
# Auxiliary encryption: AES-128 ECB.
# Record hashing: SHA-256.
# =========================================================

"""Ready-to-run role template tailored specifically for RSA SIGNATURE."""
...
DATA_FILE = "role_rsa_signature_records.pkl"
RECORDS = []
USER_KEYS = {}
