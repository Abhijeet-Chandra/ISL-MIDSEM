...
# - Encryption/decryption: Educational ElGamal public-key encryption.
# - Record hashing: SHA-256.
# - Digital signature: separate 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_ELGAMAL.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for ELGAMAL."""
...
# ========================== FIXED SETTINGS ==========================
DATA_FILE = "q07_cloud_safe_elgamal_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
...
ENCRYPTION_PUBLIC = (P, G, pow(G, PRIVATE, P))
ENCRYPTION_PRIVATE = (P, PRIVATE)
