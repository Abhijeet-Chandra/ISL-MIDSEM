...
# - Encryption/decryption: Multiplicative cipher (key 5).
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_MULTIPLICATIVE.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for MULTIPLICATIVE."""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = 5
DATA_FILE = "q07_cloud_safe_multiplicative_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
...
def decrypt_data(encrypted_data, key=CIPHER_KEY):
    ...
    return "".join(chr(((ord(ch) - 65) * inverse) % 26 + 65)
                   for ch in clean(encrypted_data))
