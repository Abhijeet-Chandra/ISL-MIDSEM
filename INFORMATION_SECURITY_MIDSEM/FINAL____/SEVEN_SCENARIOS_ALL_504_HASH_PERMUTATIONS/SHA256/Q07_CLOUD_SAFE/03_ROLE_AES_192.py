...
# - Encryption/decryption: AES-192 in ECB mode.
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_AES_192.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for AES 192."""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = b"0123456789ABCDEF01234567"
DATA_FILE = "q07_cloud_safe_aes_192_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
