...
# - Encryption/decryption: AES-128 EAX with an ECC P-256 derived key.
# - Record hashing: SHA-256.
# - Digital signature: separate 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_ECC_HYBRID.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for ECC HYBRID."""
...
# ========================== FIXED SETTINGS ==========================
DATA_FILE = "q07_cloud_safe_ecc_hybrid_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
