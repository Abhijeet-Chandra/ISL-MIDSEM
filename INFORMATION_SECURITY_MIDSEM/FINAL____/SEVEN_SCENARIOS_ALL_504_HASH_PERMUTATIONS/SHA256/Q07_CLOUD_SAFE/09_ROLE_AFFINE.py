...
# - Encryption/decryption: Affine cipher (a=5, b=8).
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_AFFINE.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for AFFINE."""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = (5, 8)
DATA_FILE = "q07_cloud_safe_affine_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
...
def decrypt_data(encrypted_data, key=CIPHER_KEY):
    a, b = key
    inverse = pow(a, -1, 26)
    return "".join(chr((inverse * (ord(ch) - 65 - b)) % 26 + 65)
