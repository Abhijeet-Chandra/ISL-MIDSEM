...
# - Encryption/decryption: Fixed permutation transposition cipher ([2,0,3,1]).
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_TRANSPOSITION.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for TRANSPOSITION."""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = [2, 0, 3, 1]
DATA_FILE = "q07_cloud_safe_transposition_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
...
def decrypt_data(encrypted_data, key=CIPHER_KEY):
    data, answer = clean(encrypted_data), ""
    for i in range(0, len(data), len(key)):
