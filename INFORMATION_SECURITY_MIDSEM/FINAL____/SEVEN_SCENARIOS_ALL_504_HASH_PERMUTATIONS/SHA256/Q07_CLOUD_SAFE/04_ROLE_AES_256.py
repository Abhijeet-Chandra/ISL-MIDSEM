...
# - Encryption/decryption: AES-256 in ECB mode.
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_AES_256.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for AES 256."""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = b"0123456789ABCDEF0123456789ABCDEF"
DATA_FILE = "q07_cloud_safe_aes_256_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
