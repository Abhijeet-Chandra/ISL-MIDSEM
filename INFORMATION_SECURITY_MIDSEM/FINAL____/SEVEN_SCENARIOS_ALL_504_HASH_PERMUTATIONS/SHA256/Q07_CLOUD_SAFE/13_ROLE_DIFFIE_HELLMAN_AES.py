...
# - Encryption/decryption: Diffie-Hellman key agreement with AES-128 EAX.
# - Record hashing: SHA-256.
# - Digital signature: separate 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_DIFFIE_HELLMAN_AES.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for DIFFIE HELLMAN AES."""
...
# ========================== FIXED SETTINGS ==========================
DATA_FILE = "q07_cloud_safe_diffie_hellman_aes_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
