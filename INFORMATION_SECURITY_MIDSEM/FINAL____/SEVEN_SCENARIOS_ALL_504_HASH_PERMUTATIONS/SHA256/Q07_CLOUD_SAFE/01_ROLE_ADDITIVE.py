...
# - Encryption/decryption: Additive/Caesar cipher (key 3).
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_ADDITIVE.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for ADDITIVE."""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = 3
DATA_FILE = "q07_cloud_safe_additive_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
