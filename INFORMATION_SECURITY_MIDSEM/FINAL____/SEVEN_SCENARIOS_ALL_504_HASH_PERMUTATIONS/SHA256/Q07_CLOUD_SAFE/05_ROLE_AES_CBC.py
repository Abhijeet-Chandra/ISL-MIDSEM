...
# - Encryption/decryption: AES-128 in CBC mode.
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_AES_CBC.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for AES CBC."""
...
DATA_FILE = "q07_cloud_safe_aes_cbc_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
