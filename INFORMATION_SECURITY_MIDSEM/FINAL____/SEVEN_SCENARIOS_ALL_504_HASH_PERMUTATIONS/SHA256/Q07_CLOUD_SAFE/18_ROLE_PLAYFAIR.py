...
# - Encryption/decryption: Playfair cipher (key MONARCHY).
# - Record hashing: SHA-256.
# - Digital signature: 2048-bit RSA with SHA-256.
# - Variant filename: ROLE_PLAYFAIR.py
# =====================================================================
...
"""Ready-to-run role template tailored specifically for PLAYFAIR."""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = "MONARCHY"
DATA_FILE = "q07_cloud_safe_playfair_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
...
def decrypt_data(encrypted_data, key=CIPHER_KEY):
    ...
    return "".join(playfair_change(a, b, matrix, -1)
                   for a, b in playfair_pairs(encrypted_data, False))
