...
# - Owner chooses an authorized recipient for each document.
# - Authorized User opens only assigned documents and verifies integrity/authenticity.
# - Auditor sees hashes/signatures/status only and may revoke user access.
...
NONCE = b"12345678"
DATA_FILE = "q12_cia_store_aes_ctr_sha256_records.pkl"
RECORDS = []
USER_KEYS = {}
REVOKED_USERS = set()
