...
# - Rename the domain/roles to MediSecure: Patient, Doctor and Hospital Administrator.
# - Replace EduSecure DES with AES-128-CBC and store the random IV with ciphertext.
# - A Doctor may open only reports assigned to that doctor's username.
# - The Administrator sees hashes, signatures and status, never decrypted reports.
# =====================================================================
# ================= EXACT ALGORITHMS USED =================
# Encryption/decryption: AES-128 in CBC mode; random IV stored before ciphertext.
...
AES-128, SHA-256 and RSA-signature role system. The uploader/reviewer/auditor internals represent Patient/Doctor/Administrator.
"""
...
DATA_FILE = "medisecure_records.pkl"
RECORDS = []
USER_KEYS = {}
