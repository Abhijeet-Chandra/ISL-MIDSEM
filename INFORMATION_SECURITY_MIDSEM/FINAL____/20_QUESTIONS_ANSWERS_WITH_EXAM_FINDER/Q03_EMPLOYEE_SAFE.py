...
# - Use Employee, HR Officer and Company Head roles for confidential contracts.
# - Use DES-CBC and retain the stored IV so older contracts can be decrypted.
# - HR checks both plaintext and ciphertext hashes plus the RSA signature.
# - The Company Head sees metadata and verification status, not plaintext.
# =====================================================================
# ================= EXACT ALGORITHMS USED =================
# Encryption/decryption: DES in CBC mode; random IV stored before ciphertext.
...
DES-CBC, SHA-256 and RSA-signature role system with persistent contracts and timestamps.
"""
...
IV = b"12345678"
DATA_FILE = "employee_contracts.pkl"
RECORDS = []
USER_KEYS = {}
...
def encrypt_data(data, key=CIPHER_KEY):
    ...
    return iv + cipher.encrypt(pad(data.encode(), DES.block_size))
