...
# - Use Student, Faculty and Examination Controller roles.
# - Replace DES with AES-256-CBC using a 32-byte key and stored random IV.
# - The Controller may revoke a student's upload permission.
# - The Controller sees hashes/signatures/remarks but not decrypted documents.
# =====================================================================
# ================= EXACT ALGORITHMS USED =================
# Encryption/decryption: AES-256 in CBC mode; random IV stored before ciphertext.
...
AES-256, SHA-256 and RSA-signature role system for result documents.
"""
...
DATA_FILE = "resultsecure_records.pkl"
RECORDS = []
USER_KEYS = {}
REVOKED_USERS = set()
