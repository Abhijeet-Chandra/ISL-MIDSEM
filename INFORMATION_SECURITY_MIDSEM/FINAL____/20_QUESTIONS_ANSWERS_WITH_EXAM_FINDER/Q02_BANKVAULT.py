...
# - Use Customer, Bank Manager and Auditor roles for transaction requests.
# - Replace DES with Triple-DES-CBC and store the IV with ciphertext.
# - Add transaction ID and PENDING/APPROVED/REJECTED status with decision time.
# - The Auditor verifies metadata/signatures but cannot decrypt transactions.
# =====================================================================
# ================= EXACT ALGORITHMS USED =================
# Encryption/decryption: Triple DES in CBC mode; random IV stored before ciphertext.
...
Triple DES, SHA-256 and RSA-signature role system. Verification status represents the manager decision trail.
"""
...
# ========================== FIXED SETTINGS ==========================
CIPHER_KEY = b"1234567890ABCDEF12345678"
DATA_FILE = "bankvault_transactions.pkl"
RECORDS = []
USER_KEYS = {}
...
def encrypt_data(data, key=CIPHER_KEY):
    ...
    return iv + cipher.encrypt(pad(data.encode(), DES3.block_size))
