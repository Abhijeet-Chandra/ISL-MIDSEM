...
# - Replace EduSecure storage with separate socket client/server terminals.
# - Client generates RSA keys and sends message, signature and public key.
# - Server reconstructs the package and verifies the RSA/SHA-256 signature.
# - Run the server first, then the client in another terminal.
# =====================================================================
"""ANSWER 18: RSA signature client/server. Requires PyCryptodome."""
