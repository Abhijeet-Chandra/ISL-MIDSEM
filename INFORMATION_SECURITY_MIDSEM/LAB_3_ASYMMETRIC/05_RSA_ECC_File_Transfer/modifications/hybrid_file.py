# MODIFICATION:
# RSA hybrid encryption: RSA wraps an AES-GCM key; AES handles file-sized bytes. This is a student-friendly addition derived from the official exercise; no source listing was supplied.
